function Puzzle(type) {
  ...
  this.draw = function() {
    ...
    // if ((this.type == 'rubik') && (snap.index.length > 0)) {
    //   this.state[snap.index[0]][snap.index[1]][snap.index[2]].colorArray = this.colorArray[8];
    //   this.state[snap.index[0]][snap.index[1]][snap.index[2]].draw();
    //   this.state[snap.index[0]][snap.index[1]][snap.index[2]].colorArray = this.colorArray[7];
    // }
