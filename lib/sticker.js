  ...
  this.drawArrows = function(){
    ...
    if (snap.snapType == 'mirror+') {
      ...
      var theta = 0.5 * Math.atan(
        ...
        (2 * arrow_vectors[0].x *arrow_vectors[1].x + 2 * arrow_vectors[0].y *arrow_vectors[1].y) );
      
      var longAxis = new Point2D(arrow_vectors[0].x * Math.cos(theta) + arrow_vectors[1].x * Math.sin(theta), arrow_vectors[0].y * Math.cos(theta) + arrow_vectors[1].y * Math.sin(theta));
      var shortAxis = new Point2D(-arrow_vectors[0].x * Math.sin(theta) + arrow_vectors[1].x * Math.cos(theta), -arrow_vectors[0].y * Math.sin(theta) + arrow_vectors[1].y * Math.cos(theta));
      ...
      var radiusx = longAxis.norm * 0.05;
      var radiusy = shortAxis.norm * 0.05;
