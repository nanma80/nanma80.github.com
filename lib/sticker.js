function Sticker(normal, offset, colorArray, size) {
  ...
  this.drawArrows = function(){
    ...
    if (snap.snapType == 'mirror+') {
      ...
      var longAxis = new Point2D(arrow_vectors[0].x * Math.cos(theta) + arrow_vectors[1].x * Math.sin(theta), 
                                 arrow_vectors[0].y * Math.cos(theta) + arrow_vectors[1].y * Math.sin(theta));

      var shortAxis = new Point2D(arrow_vectors[0].x * Math.cos(theta + Math.PI/2) + arrow_vectors[1].x * Math.sin(theta + Math.PI/2), 
      ...
      console.log([arrow_vectors[0].x, arrow_vectors[0].y, arrow_vectors[1].x, arrow_vectors[1].y, theta, angle]);
