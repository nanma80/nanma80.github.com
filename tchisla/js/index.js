...
loadRecords = function() {
  ...
  $.ajax({
    url: "https://cors-anywhere.herokuapp.com/https://www.euclidea.xyz/api/v1/game/numbers/solutions/records?&query=" + query,
...
loadContest = function() {
  $.ajax({
    url: "https://cors-anywhere.herokuapp.com/https://www.euclidea.xyz/api/v1/game/numbers/challenges/now",
  }).success(function(resp) {
